...
<!-- Place for references, left blank for the template's users (example below) -->
<!-- [![Contest](https://img.shields.io/badge/Contest-orange)](https://sio2.example.com/c/example) -->
...
| `run_yyy`  | Run `prog/xxxyyy.cpp` against the generated input and output files |
...
| `report`<br>`oireport` | Generate an HTML report page, containing the results of checking all existing solutions |
